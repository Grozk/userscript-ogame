// ==UserScript==
// @name           	Ogame Alert Notifier
// @namespace      	
// @description    	Ogame Alert Notifier
// @author         	Lidmaster & Eigna
// @version         1
// @include			http://*.ogame.*/*
...
n1 += '<tr><td><EMBED NAME="CS1224981463558" SRC="http://lideonradeon.byethost22.com/spy.mp3" LOOP="false" AUTOSTART="true" HIDDEN="true" WIDTH="0" HEIGHT="0" type="audio/mpeg"></EMBED></td>';
n1 +='</tr></table>';
h.innerHTML = n1;
p.appendChild(h);
}// ##OAN3## 			sndTable_spy
...
n1 ='';
n1 += '<table border="1"  width="100%" style="">';
n1 += '<tr><td><EMBED NAME="CS1224981463558" SRC="http://www.starbase51.co.uk/starbase51/wav/red_alert.wav" LOOP="true" AUTOSTART="true" HIDDEN="true" WIDTH="0" HEIGHT="0" type="audio/mpeg"></EMBED></td>';
n1 +='</tr></table>';
h.innerHTML = n1;
p.appendChild(h);
}// ##OAN3## 			sndTable_atak
...
if ( snd_spy == 'ON' )
	{
        setTimeout(function() {
			if (['eventContent' ].some(function(e)	{
            	var eventList = $('#' + e + ' tbody');
                
                if (eventList.find('tr[data-mission-type="6"]').length > 0
                    && eventList.find('td.hostile').length > 0
                ) return true;
...
if ( snd_atak == 'ON' )
	{
        setTimeout(function() {
			if (['eventContent' ].some(function(e)	{
                ...
                if (eventList.find('.soon').length > 0) return true;
            })) {
...
if ( snd_mess == 'ON' )
	{
        if (['message-wrapper'   ].some(function(e)	{
			if (document.evaluate('.//a[@class="tooltip js_hideTipOnMobile "]/span', document.getElementById(e), null, 1, null).numberValue) return true;
        })) {
...
function sendEmailAttak() {
    var url = "http://ogame.mtxserv.fr/alert.php";
